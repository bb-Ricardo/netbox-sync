...
class OpenStackConfig(ConfigBase):

    section_name = source_config_section_name
    source_name = None
    source_name_example = "my-openstack-example"

    def __init__(self):
        self.options = [
            ConfigOption(**config_option_enabled_definition),

            ConfigOption(**{**config_option_type_definition, "config_example": "openstack"}),

            ConfigOption("auth_url",
                         str,
                         description="host name / IP address of the OpenStack",
                         config_example="https://api.openstack-instance.local:5000/v3",
                         mandatory=True),

            ConfigOption("project",
                         str,
                         description="Name of the OpenStack project",
                         config_example="MyProject",
                         mandatory=True),

            ConfigOption("username",
                         str,
                         description="username to use to log into OpenStack",
                         config_example="openstackuser",
                         mandatory=True),

            ConfigOption("password",
                         str,
                         description="password to use to log into OpenStack",
            ...
            ConfigOption("region",
                         str,
                         description="Which OpenStack region to use",
                         config_example="RegionOne",
                         mandatory=True),

            ConfigOption("user_domain",
                         str,
                         description="Which OpenStack user domain to use",
                         config_example="Default",
                         mandatory=True),

            ConfigOption("project_domain",
                         str,
                         description="Which OpenStack project domain to use",
                         config_example="Default",
                         mandatory=True),

            ConfigOption("group_name",
                         str,
                         description="OpenStack group name",
